...
function team6_n180140_validation()
{
    ...
    if(t6_sri==false)
    {
        document.getElementById("mani").style.display="visible";
...
function fun()
{
    progress=progress*1.65844912;
    var j=progress.toString()+"px";
    document.getElementById("progress_in").style.width=j;
}
